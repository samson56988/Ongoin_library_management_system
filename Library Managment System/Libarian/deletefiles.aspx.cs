    ...
    public partial class deletefiles : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if(Request.QueryString["id"]!=null)
            {
                ...
                cmd.CommandText = "update Book set booksvideo=''where id='"+Request.QueryString["id"].ToString()+" ' ";
                cmd.ExecuteNonQuery();
            ...
            else if(Request.QueryString["id1"]!=null)
            {
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update Book set bookspdf=''where id='" + Request.QueryString["id1"].ToString() + " ' ";
                cmd.ExecuteNonQuery();
            ...
            else
            {
                ...
                SqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "delete Book where id='" + Request.QueryString["id2"].ToString() + " ' ";
                cmd.ExecuteNonQuery();
