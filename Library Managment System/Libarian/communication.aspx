<%@ Page Title="" Language="C#" MasterPageFile="~/Libarian/Site1.Master" AutoEventWireup="true" CodeBehind="communication.aspx.cs" Inherits="Library_Managment_System.Libarian.communication" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cl" runat="server">


    <div class="row" style="margin:10px">

        <div class="col-lg-12" style="height:400px; border-style:solid; border-width:1px; background-color:white; overflow:auto" id="msgrace"></div>
