...
namespace Library_Managment_System
{
    public partial class load_messages : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from Messages where (susername='" + username.ToString() + "' and dusername='Libarian') or select * from Messages where (dusername='" + username.ToString() + "' and susername='Libarian') ";
            ...
            foreach(DataRow dr in dt.Rows)
            {
                ...
                if(dr["dusername"].ToString()=="Libarian")
                {
